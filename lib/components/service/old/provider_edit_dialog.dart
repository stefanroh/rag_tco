...
import 'package:rag_tco/components/service/old/unit_selector.dart';
...
class _ProviderEditDialogState extends ConsumerState<ProviderEditDialog> {
  UnitTypesLegacy selectedUnitType = UnitTypesLegacy.unknown;
                        ...
                        for (var i = 0;
                          ...
                          TableRow(children: [
                            ...
                            TableCell(
                                child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text(ProviderInformation.getUnitTypesLegacytring(
